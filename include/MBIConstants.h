...
namespace MBISDK
{
	...
	namespace MBIAttr
	{
		...
		namespace Name
		{
			...
			/// @brief HDF5 MS parameter data
			static constexpr const char* SCAN_DEFINITIONS = "scan-definitions"; // Collision energy, isolation window, etc
			...
			static constexpr const char* CAL_CCS_TRADITIONAL = "cal-css-traditional"; ///< Traditional (json) ccs coefficients.
			/// @brief HDF5 Scan definition for a given frame
			static constexpr const char* SCAN_DEFINITION_TABLE = "%d";
			/// @brief HDF5 Scan definition changepoints (in scan index, within a frame)
			static constexpr const char* SCANDEF_SETPOINT_INDICES = "indices";
			/// @brief HDF5 Scan definition interpolation mode.
			static constexpr const char* SCANDEF_INTERPOLATION_MODE = "interpolation-mode";
			///@brief HDF5 Scan definition setpoints (for non-windowed parameters)
			static constexpr const char* SCANDEF_SETPOINTS = "setpoints";
			/// @brief HDF5 Scan definition start point for windowed parameter
			static constexpr const char* WINDOW_START = "window-start";
			/// @brief HDF5 Scan definition end point for windowed parameter
			static constexpr const char* WINDOW_END = "window-end";
			/// @brief HDF5 Scan definition table for isolation windows point for windowed parameter
			static constexpr const char* ISOLATION_WINDOWS = "isolation-windows";
			/// @brief HDF5 Scan definition table for collision energy
			static constexpr const char* COLLISION_ENERGY = "collision-energy";
			/// @brief HDF5 frame index to scan definition index mapping:
			static constexpr const char* SCANDEF_MAPPING = "mapping";
		};
    ...
    /// @brief Ion polarity (of a frame or an entire file)
    enum class IonPolarity
    {
        POSITIVE,
        NEGATIVE,
        BOTH,
